...
mwjson.schema = class {
    ...
    static getAutocompletePreviewTemplate(subschema) {
        ...
        '<img style="height:66" src="' + isg.util.articlePath('Special:Redirect/file/{{result.printouts.image.[0].fulltext}}?width=100&height=50') + '"></img></div></div><br>{{/if}}' +
        '<a href="'+ isg.util.articlePath( "{{result.fulltext}}" ) + "\">{{result.printouts.label.[0]}}</a>" + 
